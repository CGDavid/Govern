...
urlpatterns = [
    ...
    url(r'^projectes/acceptar$', views.acceptaProjecte, name='projectes.accepta'),
    url(r'^projectes/rebutjar/(?P<id>[0-9]+)$', views.rebutjaProjecte, name='projectes.rebutja'),
    url(r'^projecte/(?P<projecte_id>[0-9]+)/elimina/evaluacio/(?P<evaluacio_id>[0-9]+)$', views.eliminaEvaluacio, name='projectes.eliminaEvaluacio'),
